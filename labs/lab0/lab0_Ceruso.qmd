...
- Rows: 50000
- Columns: 7  
- Variable types: numeric and character variables
- Problematic names: "Engine size" or "Fuel type" due to spaces in between words
...
**Your answer:** The tibble shows the first 10 rows of data, and each variable
is denoted as either character or numeric, whereas the dataframe shows rows 
until it reaches its max, in this case 142 rows. The dataframe does not 
specify whether the variables are characters or numeric.
...
**Your answer:** Because there were spaces between each word.
...
filter(car_data_new, Manufacturer == "Honda" & Manufacturer == "Nissan")
